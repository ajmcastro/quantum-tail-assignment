...
class Solver(GenericSolver):
    ...
    def get_final_solution(self, sampler = macros.SAMPLER, to_print=True, print_matrix=False, export=False, modeltime=0):
        return super().get_final_solution(sampler = sampler, to_print=to_print, print_matrix=print_matrix, export=export, modeltime=modeltime, modulation='csp')
    
    def get_energy_solution(self, sampler = macros.SAMPLER):
        return super().get_energy_solution(sampler = sampler, modulation='csp')